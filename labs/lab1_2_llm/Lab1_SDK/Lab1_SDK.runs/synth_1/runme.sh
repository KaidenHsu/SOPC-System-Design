...
HD_PWD='C:/Users/ryanh/Lab1_SDK/Lab1_SDK.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_SDK_sys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1_SDK_sys_wrapper.tcl
