...
HD_PWD='C:/Users/ryanh/Lab1_SDK/Lab1_SDK.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1_SDK_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab1_SDK_sys_wrapper.tcl -notrace
