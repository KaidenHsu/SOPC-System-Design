...
HD_PWD='C:/Users/ryanh/fpga/sopc/Lab1_led/Lab1_led.runs/design_1_led_round_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_led_round_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_led_round_0_0.tcl
