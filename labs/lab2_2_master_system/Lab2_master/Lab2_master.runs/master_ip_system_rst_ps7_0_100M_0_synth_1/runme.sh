...
HD_PWD='C:/Users/ryanh/Lab2_master/Lab2_master.runs/master_ip_system_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log master_ip_system_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source master_ip_system_rst_ps7_0_100M_0.tcl
