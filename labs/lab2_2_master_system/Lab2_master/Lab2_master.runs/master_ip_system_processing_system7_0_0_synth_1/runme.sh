...
HD_PWD='C:/Users/ryanh/Lab2_master/Lab2_master.runs/master_ip_system_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log master_ip_system_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source master_ip_system_processing_system7_0_0.tcl
