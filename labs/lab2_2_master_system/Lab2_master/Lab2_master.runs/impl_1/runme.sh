...
HD_PWD='C:/Users/ryanh/Lab2_master/Lab2_master.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log master_ip_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source master_ip_system_wrapper.tcl -notrace
