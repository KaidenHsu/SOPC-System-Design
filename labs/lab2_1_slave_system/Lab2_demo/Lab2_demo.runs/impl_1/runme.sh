...
HD_PWD='C:/Users/ryanh/Lab2_demo/Lab2_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_two_slaves_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2_two_slaves_wrapper.tcl -notrace
