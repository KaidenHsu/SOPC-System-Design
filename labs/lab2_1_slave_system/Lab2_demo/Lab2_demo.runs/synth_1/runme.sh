...
HD_PWD='C:/Users/ryanh/Lab2_demo/Lab2_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_two_slaves_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2_two_slaves_wrapper.tcl
