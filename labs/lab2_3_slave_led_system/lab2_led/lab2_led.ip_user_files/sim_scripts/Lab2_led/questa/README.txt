...
#
# Generated by export_simulation on Tue May 05 23:38:10 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './Lab2_led.sh' script.

./Lab2_led.sh -reset_run
...
./Lab2_led.sh -noclean_files

For more information on the script, please type './Lab2_led.sh -help'.
