...
HD_PWD='C:/Users/ryanh/fpga/sopc/lab2_led/lab2_led.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_led_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2_led_wrapper.tcl -notrace
