...
HD_PWD='C:/Users/ryanh/fpga/sopc/lab2_led/lab2_led.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_led_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2_led_wrapper.tcl
