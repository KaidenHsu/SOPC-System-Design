...
#
# Generated by export_simulation on Wed May 06 21:07:33 +0800 2026
#
################################################################################
...
'-reset_run' switch to the './HW4_system.sh' script.

./HW4_system.sh -reset_run
...
./HW4_system.sh -noclean_files

For more information on the script, please type './HW4_system.sh -help'.
