...
HD_PWD='C:/SOPC/HW4/HW4/HW4/HW4.runs/HW4_system_rst_ps7_0_100M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HW4_system_rst_ps7_0_100M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HW4_system_rst_ps7_0_100M_0.tcl
