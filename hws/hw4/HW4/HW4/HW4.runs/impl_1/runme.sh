...
HD_PWD='C:/Users/ryanh/Downloads/HW4/HW4/HW4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log HW4_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source HW4_system_wrapper.tcl -notrace
