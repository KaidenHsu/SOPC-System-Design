...
HD_PWD='C:/Users/ryanh/Downloads/HW4/HW4/HW4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HW4_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HW4_system_wrapper.tcl
